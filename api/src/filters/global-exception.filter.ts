...
export class GlobalExceptionsFilters implements ExceptionFilter {
    ...
    if (exception instanceof HttpException) {
      ...
      // Check if response body is an object and extract details if available
      ...
      // Specific handling for some HTTP status codes
      switch (status) {
    ...
    // Log the exception (you can use any logger service here)
    console.error({
