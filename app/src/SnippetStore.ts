...
export const snippetStoreHarvest = writable<HarvestInterface[]>([]);
// addSnippet
...
// toggleFavorite
// export function toggleFavoriteHarvest(index: any) {
//     let snippets = get(snippetStoreHarvest);
//     return snippets.length > index ? false : true
//     // console.log("snippet", snippets)
//     // snippetStoreHarvest.update(() => { // [ { favorite: true }, { favorite: false } ]  1
//     //     return snippets.map((snippet, snippetIndex) => {
//     //         if(snippetIndex === index) {
//     //             return { ...snippet, favorite: !snippet.favorite }
//     //         }
